          ...
          <div class="sale-box">
            <div class="box-quota">
              <div class="quota-item quota-box">
                <div class="item-num">{{ saleTotal.monthSales }}</div>
                <div class="item-txt">我的本月销售额</div>
              </div>
              <div class="quota-item">
                  <div class="item-num">{{ saleTotal.monthSubSales }}</div>
                <div class="item-txt">分销本月销售额</div>
              </div>
            </div>
          </div>
            ...
            <div class="popup-content">
                <div class="drawer-box">
                    ...
                    <div class="drawer-content">
                        ...
                        <div class="d-picker">
                            <picker mode="date" :value="dateStart" fields='month' :end="today" @change="bindDateChange">
                    ...
                    <div class="drawer-content">
                        ...
                        <div class="d-picker">
                            <picker mode="date" :value="dateEnd" fields='month' :start="dateStart" :end="today" @change="bindDateChange2">
                                <view class="picker">
                                    {{dateEnd}}
                                </view>
                            </picker>
