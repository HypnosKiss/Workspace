...
return [
    ...
    //JSON输入转换中间件格式
    'case_input_format' => env('CASE_INPUT_FORMAT', \ZhiEq\CaseJson\ConvertJsonKeyFormat::FORMAT_CAMEL_CASE),

    //JSON输出转换中间件格式
    'case_output_format' => env('CASE_OUTPUT_FORMAT', \ZhiEq\CaseJson\ConvertJsonKeyFormat::FORMAT_CAMEL_CASE),
    ...
    'verification_code_expired_time' => 180
];
