...
class Query
{
     ...
     * @var 2017-6-1
    */
    public function getSqlWithIndex($sql, $index_key = '', $bind = [], $master = false, $class = false)
    {
        $result = $this->query($sql, $bind, $master, $class);
    ...
    public function updateAll($set, $index_key)
    {
        ...
        $options = $this->parseExpress();
        $sql = "UPDATE {$options['table']} SET {$update_info['fields']} WHERE {$update_info['conditions']}";
